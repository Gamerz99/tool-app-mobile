...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_service_service__ = __webpack_require__(153);
...
var ServiceProvider = /** @class */ (function () {
    function ServiceProvider(http) {
        this.http = http;
        this.url = 'https://app-1541946809.000webhostapp.com/index.php/api';
    }
    ...
    ServiceProvider.prototype.login = function (credentials) {
        return this.http.post(this.url + '/employee_api/login', credentials).map(function (res) { return res.json(); });
    };
